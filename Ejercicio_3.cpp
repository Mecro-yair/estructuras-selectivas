...
int main(){
	...
	cout<<"Digite el numero de camisas:"<<endl; cin>>numero_de_camisas;
	cout<<"Digite el costo total de las camisas:"<<endl; cin>>total_compra;
	if (numero_de_camisas>0 && total_compra>0){
